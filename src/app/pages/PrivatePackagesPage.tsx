              ...
              <div key={pkg.packageId} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4">
                ...
                <div className="flex gap-2 pt-3 border-t border-slate-100 mt-3">
                  ...
                  {ratedRefs.has(pkg.packageId) ? (
                    ...
                    <Link
                      to={`/feedback/Private/${pkg.packageId}?label=${encodeURIComponent(pkg.packageName || '')}&coach=${encodeURIComponent(pkg.coachFullName || '')}&location=${encodeURIComponent(pkg.locationNickName || '')}`}
                      title={t('fb.give')}
                      className="flex items-center justify-center px-3 py-2.5 rounded-xl"
